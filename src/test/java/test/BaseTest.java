...
public class BaseTest {
	...
	public void testApi() throws Exception {
		// try {
		// ForJoinServicePrx ice = IceServiceProxy.getTradeForInceptorService();
		// TradeInfoEntity out = ice.tradeInfoJudge("46000008002");
	...
	//
	// BigDecimal b = new BigDecimal(1.45210225029689E19);
	// System.out.println(b.toString());

	// MemKeyOperator dateOperator =
	// MemPrefixEnum.MANAGER.keyOperator("MANAGER_JC_FORMULA_1210_125829669");
	// System.out.println("^^^^^^^^^^^ "+dateOperator.get());
	// System.out.println("&&&&&&&&&&&&& "+dateOperator.getFullKey());
	// dateOperator.delete();
	...
	// List<GradeTypeEnum> list = GradeTypeEnum.getContainGradeType(0);
	//
	// System.out.println("list.size = "+list.size());
	//
	// for (GradeTypeEnum type : list) {
	// System.out.println(type.getNameZh());
	// }
//    	
//    	StringBuilder sb = new StringBuilder();
//    	sb.append("ChenYa");
//    	sb.append(StringUtil.BLANK_SPACE);
//    	sb.append("is a beauiful bitch!");
...
//         } while (c != 'q');
          ...
          System.out.println(test("test4",1));
    	
    }
    
    // 泛型方法 printArray                         
    public static < W > void printArray( W[] inputArray )
    {
       // 输出数组元素            
